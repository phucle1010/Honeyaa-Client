...
const dataEducation = ['high school', 'college', 'graduate school'];
            ...
            <View style={styles.modalContainer}>
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <TouchableOpacity
                            style={{ position: 'absolute', color: '#FF6868', top: 0, right: 0 }}
                            onPress={onPress}
                        >
                        ...
                        <Pressable onPress={onPress} style={[styles.button, styles.buttonClose]}>
