...
const SettingBirth = ({navigation, route}) => {
    ...
    const handlePress = useCallback(() => {
        navigation.navigate('SettingAddPhotos', {phone, pass, name, birthday: birthday.toISOString().substring(0, 10)});
            ...
            <View style={{flex: 1}}>
                <View style={{height: 90, flexDirection: 'row'}}>
                    <View style={{width: 70, flexDirection: 'column'}}>
                        ...
                        <TouchableOpacity onPress={() => setOpenDatePicker(true)} style={{height: 46, width: 70, borderWidth: 1, borderColor: '#B2B2B2', borderStyle: 'solid', marginTop: 16, borderRadius: 10, flexDirection: 'row'}}>
                ...
                <TouchableOpacity style={{
                    ...
                    <Text style={{color: '#FFFFFF'}} onPress={() => handlePress()}>Continue</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
