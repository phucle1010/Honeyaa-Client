...
const VerifyCreatedPhone = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.text}>Enter the code we've send by text to {phone}</Text>
            <TouchableOpacity>
            ...
            <TouchableOpacity onPress={ConfirmOTP} style={[{ backgroundColor: '#503EBF', marginTop: 39 }, styles.btn]}>
...
export default VerifyCreatedPhone;
