...
const InputItem = (props) => {
    ...
    return (
        <View style={{ height: 44 }}>
            <TextInput value={value} style={styles.textInput} editable={false} onPressOut={() => Alert.alert('hello')} placeholder={placeholder} placeholderTextColor={'#B2B2B2'} />
                    ...
                    <View style={[styles.container0, { backgroundColor: isOpen ? "gray" : "white" }]}>
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View style={styles.profile}>
                                ...
                                <View style={{ height: 44 }}>
                                    <TextInput style={[styles.textInput, { backgroundColor: isOpen ? 'gray' : '#FFFFFF' }]} placeholder={'Introduce yourself...'} placeholderTextColor={'#B2B2B2'} />
                                </View>
                            ...
                            <View style={styles.profile}>
                                ...
                                <View>
                                    <TouchableWithoutFeedback onPress={() => Alert.alert('hello')}>
                                        <View style={{ height: 44 }}>
                                            <TextInput editable={false} style={[styles.textInput, { backgroundColor: isOpen ? 'gray' : '#FFFFFF' }]} placeholder={'Interest'} placeholderTextColor={'#B2B2B2'} />
                                        </View>
                                    </TouchableWithoutFeedback>
                                    <Text style={[styles.text0, { position: 'absolute', top: 5, right: 23, zIndex: 1 }]}>Add</Text>
                                    <Icon name="chevron-forward-outline" size={15} style={styles.iconInput} />
                                </View>
                            ...
                            <View style={styles.profile}>
                                ...
                                <TouchableWithoutFeedback onPress={() => Alert.alert('hello')}>
                                    <View style={{ height: 44 }}>
                                        <TextInput style={[styles.textInput, { backgroundColor: isOpen ? 'gray' : '#FFFFFF' }]} editable={false} onPressOut={() => Alert.alert('hello')}
                                            placeholder={'Adress'}
                            ...
                            <View style={styles.profile}>
                                ...
                                <TouchableWithoutFeedback onPress={() => Alert.alert('hello')}>
                                    <View style={{ height: 44 }}>
                                        <TextInput style={[styles.textInput, { backgroundColor: isOpen ? 'gray' : '#FFFFFF' }]}
                         ...
                         ref={scrollViewRef}>
                            ...
                            <View style={styles.contentContainer}>
                                ...
                                <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                                    {dataZodiac.map(i =>
                                        <Pressable key={i} style={{ borderWidth: 0.5, borderColor: '#000', margin: 5, borderRadius: 20 }}>
